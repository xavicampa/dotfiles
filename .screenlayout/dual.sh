...
# nvidia-settings --assign CurrentMetaMode="DPY-1: 3840x2160_60_0 @3840x2160 +3840+0 {ViewPortIn=3840x2160, ViewPortOut=3840x2160+0+0, ForceCompositionPipeline=On, ForceFullCompositionPipeline = On}, DPY-0: 3840x2160_60_0 @3840x2160 +0+0 {ViewPortIn=3840x2160, ViewPortOut=3840x2160+0+0, ForceCompositionPipeline=On, ForceFullCompositionPipeline = On}"
nvidia-settings --assign CurrentMetaMode="DPY-1: 3840x2160_60_0 @3840x2160 +3840+0 {ViewPortIn=3840x2160, ViewPortOut=3840x2160+0+0}, DPY-0: 3840x2160_60_0 @3840x2160 +0+0 {ViewPortIn=3840x2160, ViewPortOut=3840x2160+0+0}"
