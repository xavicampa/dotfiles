...
in
{
  "@aws-amplify/cli" = nodeEnv.buildNodePackage {
    ...
    version = "9.2.1";
    src = fetchurl {
      url = "https://registry.npmjs.org/@aws-amplify/cli/-/cli-9.2.1.tgz";
      sha512 = "EqpyRFyUEGoV/A43DpjdfSKlQfWXBJ7BTY1roEnGbke0NEIAdTc+dULJTRPzNdzRuU5CluyQp4KjnDFrFvTlIg==";
    };
    dependencies = [
